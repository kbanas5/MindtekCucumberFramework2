  ...
  Feature: Pizza application place order functionality
    ...
    Scenario Outline: Validating successful place order
      ...
      Examples:
        ...
        | Large 10 Slices - 2 toppings | Olives      | Salami       | 2        | Kim Yan     | kim@gmail.com   | 123456789 | Credit Card    |
        | Medium 8 Slices - 2 toppings | Diced Mango | Italian Ham  | 3        | John Doe    | john@gmail.com  | 123456789 | Cash on Pickup |
